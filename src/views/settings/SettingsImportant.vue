...
div
  ...
  .row.grid
    input(placeholder="3000" v-model.number="settings.autoHideHintsDelay")
    div
  ...
  .row.grid
    input(placeholder="500px" v-model="settings.width")
    p.name Grid Width

  .row.grid
    input(placeholder="60px" v-model="settings.worldSize")
    p.name World Icon Size

  .row.grid
    input(placeholder="7.5px" v-model="settings.worldVerticalPadding")
    p.name World Row Vertical Padding

  .row.grid
    input(placeholder="55px" v-model="settings.checkSize")
    p.name Check Icon Size

  .row.grid
    input(placeholder="2.5px" v-model="settings.checkVerticalPadding")
