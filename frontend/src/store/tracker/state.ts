export const items: { [key: string]: { [key: string]: any } } = {
  ...
  "worlds/cavern_of_remembrance": {
    secondary: ["depths", "mining", "engine", "transport"].map(
      (i) => `secondary/cor/${i}`
    ),
  },
  ...
  "worlds/olympus_coliseum": {
    total: 2,
    data: "zexion",
    secondary: ["pain_panic", "cerberus", "titan", "goddess", "paradox"].map(
      (c) => `secondary/cups/${c}`
    ),
  },
  ...
  "worlds/the_world_that_never_was": {
    data: "xemnas",
    secondary: ["roxas", "xigbar", "luxord", "saix", "kingdom_hearts"].map(
      (i) => `nobody/${i}`
    ),
  },
  ...
  "worlds/100_acre_wood": {
    total: 6,
    secondary: ["page", "page2", "page3", "page4", "page5"].map(
      (p) => `secondary/pages/${p}`
    ),
    cls: "hundred_acre",
  },
  ...
  // Level
  "other/sora's_level": { total: 27, level: 1 },

  // Drives
  "drive/valor": {
    total: 7,
    secondary: ["jump", "jump2", "jump3", "jump4"].map(
      (i) => `secondary/drive/${i}`
    ),
    cls: "drive",
  },
  "drive/wisdom": {
    total: 7,
    secondary: ["quick", "quick2", "quick3", "quick4"].map(
      (i) => `secondary/drive/${i}`
    ),
    cls: "drive",
  },
  "drive/limit": {
    total: 7,
    secondary: ["dodge", "dodge2", "dodge3", "dodge4"].map(
      (i) => `secondary/drive/${i}`
    ),
    cls: "drive",
  },
  "drive/master": {
    total: 7,
    secondary: ["aerial", "aerial2", "aerial3", "aerial4"].map(
      (i) => `secondary/drive/${i}`
    ),
    cls: "drive",
  },
  "drive/final": {
    total: 7,
    secondary: ["glide", "glide2", "glide3", "glide4"].map(
      (i) => `secondary/drive/${i}`
    ),
    cls: "drive",
  },
...
[
  ...
  ...[...Array(4).keys()].map(
    (i) => `secondary/drive/jump${i ? i + 1 : ""}.png`
  ),
  ...[...Array(4).keys()].map(
    (i) => `secondary/drive/quick${i ? i + 1 : ""}.png`
  ),
  ...[...Array(4).keys()].map(
    (i) => `secondary/drive/dodge${i ? i + 1 : ""}.png`
  ),
  ...[...Array(4).keys()].map(
    (i) => `secondary/drive/aerial${i ? i + 1 : ""}.png`
  ),
  ...[...Array(4).keys()].map(
    (i) => `secondary/drive/glide${i ? i + 1 : ""}.png`
  ),
  ...["bronze", "silver", "gold"].map((c) => `secondary/crowns/${c}.png`),
  ...["pain_panic", "cerberus", "titan", "goddess", "paradox"].map(
    (c) => `secondary/cups/${c}.png`
  ),
  ...["roxas", "xigbar", "luxord", "saix", "kingdom_hearts"].map(
    (i) => `nobody/${i}.png`
  ),
  ...["depths", "mining", "engine", "transport"].map(
    (i) => `secondary/cor/${i}.png`
  ),
